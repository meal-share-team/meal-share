    ...
    <div className="min-h-screen bg-white font-sans antialiased text-slate-900">
      ...
      <nav className="flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold tracking-tighter text-black">Meal Share</h1>
        </div>
        
        <div className="hidden md:flex items-center gap-8">
          <Link to="/suggestions" className="text-sm font-semibold text-slate-600 hover:text-black transition-colors">
            Browse Meals
          </Link>
          <Link to="/login" className="text-sm font-semibold text-slate-900 hover:opacity-70">
            Sign In
          </Link>
          <Link 
            to="/signup" 
            className="bg-black !text-white px-6 py-3 rounded-full text-sm font-bold hover:bg-slate-800 transition-all shadow-md shadow-black/10"
          >
            Get Started
          </Link>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-8 py-16 lg:py-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-10">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
            <Link 
              to="/signup" 
              className="w-full sm:w-auto bg-black !text-white px-10 py-5 rounded-2xl text-lg font-extrabold hover:bg-slate-800 hover:scale-[1.02] transition-all shadow-xl shadow-black/20 text-center"
            >
              Join Meal Share
            </Link>
            <Link 
              to="/suggestions" 
              className="w-full sm:w-auto bg-white border-2 border-slate-100 px-10 py-5 rounded-2xl text-lg font-bold hover:bg-slate-50 hover:border-slate-200 transition-all text-center"
            >
              Explore Menu
            </Link>
          </div>
